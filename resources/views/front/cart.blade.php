                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center justify-content-space-between">
                                            @php
                                                // Check if the product image exists in options and get the image path
                                                $image = isset($item->options->product_images->image) 
                                                         ? 'uploads/product/small/' . $item->options->product_images->image 
                                                         : 'admin-assets/img/default-150x150.png';
                                            @endphp
                                            <img src="{{ asset($image) }}" alt="{{ $item->name }}">
                                            <h2>{{ $item->name }}</h2>
                                        </div>
                                    </td>
                                    <td>${{ $item->price }}</td>
