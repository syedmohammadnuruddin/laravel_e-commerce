            ...
            <div class="col-md-8">
                ...
                <div class="card mb-3">
                    <div class="card-body">	
                        ...
                        <div class="mb-3">
                            <select multiple class="form-control related-product" id="related_products" name="related_products[]">
    ...
    $("#title").change(function(){
        ...
        $('#category').change(function(){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    $.each(response.subCategories, function(key, item){ // Access subCategories directly from response
        ...
        const dropzone = $("#image").dropzone({ 
            ...
            headers: {
                ...
                // Refresh Dropzone after adding the image to ensure it clears the preview and is ready for new uploads
